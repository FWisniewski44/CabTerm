...
+ Liegt ein Zwei-Kammern-System vor? (*erdda_bicam*, hazard ratio = 3,31)
+ Wie viele effektive Parteien sind im Parlament vorhanden? (*effec_parties_parl*, hazard ratio = 1,71)
+ Wie groß ist die parlamentarische Preference Range? (*parl_pref_range*, hazard ratio = 0,99)
+ Handelt es sich um ein Kabinett, welches nach einer regulären Wahl zustande gekommen ist? (*post_election_cabinet*, hazard ratio = 0,35)
+ Wie lange dauerten die Koalitionsverhandlungen? (*erdda_barg_dur*, hazard ratio = 1,01)
+ Steht dem Kabinett der gleiche Premierminister vor, wie schon dem vorigen Kabinett(*same_pm*, hazard ratio = 2,15)
+ Wie groß ist der Sitzanteil des Kabinettes? (*cab_seat_share*, hazard ratio = 0,96)
...
Wie aktuell auch Walther und Hellström mittels einer Extreme Bounds Analyse aufzeigen, hat die Anzahl effektiver Parteien einen robusten Einfluss auf die Regierungsdauer in Mittel- und Osteuropa - und ist dabei nicht abhängig von der Aufnahme oder dem Ausschluss von anderen Kovariaten (vgl. Walther/Hellström 2021, S. 15-16). Vorliegende Arbeit konnte ebenfalls einen Einfluss dieser Variable im Falle der Analyse von Minderheitsregierungen im abschließenden Modell feststellen.
